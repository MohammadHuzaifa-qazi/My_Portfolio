  ...
  return (
    <div className="flex items-center">
      <motion.div
        ...
        className="h-4 w-4 rounded-full bg-[#61DAFB] shadow-[0_0_12px_rgba(97,218,251,0.6)]"
      />
      <motion.div
        initial={{
          x: 0,
        ...
        className="h-4 w-4 -translate-x-2 rounded-full bg-[#61DAFB] shadow-[0_0_12px_rgba(97,218,251,0.6)]"
      />
      <motion.div
        initial={{
          x: 0,
        ...
        className="h-4 w-4 -translate-x-4 rounded-full bg-[#61DAFB] shadow-[0_0_12px_rgba(97,218,251,0.6)]"
      />
    </div>
  );
};
