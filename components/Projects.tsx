...
export function Projects() {
  return (
    <section id="projects" className="relative py-24 px-6 md:px-12 lg:px-20">
      <div className="absolute right-[10%] top-1/4 h-72 w-72 rounded-full bg-[radial-gradient(circle,rgba(120,255,180,.06),transparent_70%)] blur-3xl" />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="font-sans text-[11px] uppercase tracking-[0.3em] text-white/35 mb-6">Portfolio</div>
          <h2 className="text-4xl md:text-6xl font-bold mb-16 tracking-[-0.04em]">
            Featured <span className="text-[#61DAFB]">Projects</span>
          </h2>
            ...
            {PROJECTS.map((project, i) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/40 text-sm mb-6 leading-relaxed line-clamp-3">
                    {project.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="px-3 py-1 text-[10px] rounded-full bg-white/[0.04] border border-white/[0.06] text-white/45"
                      >
                        {t}
                      </span>
                    ))}
